...
namespace ModernWebStore.CrossCutting
{
    public static class DependencyRegister
    {
        ...
        public static void Register(UnityContainer container)
        {
            ...
            container.RegisterType<IPessoaJuridicaApplicationService, PessoaJuridicaApplicationService>(new HierarchicalLifetimeManager());
            container.RegisterType<IPessoaFisicaApplicationService, PessoaFisicaApplicationService>(new HierarchicalLifetimeManager());
