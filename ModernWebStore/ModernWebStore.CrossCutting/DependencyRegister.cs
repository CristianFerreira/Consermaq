...
namespace ModernWebStore.CrossCutting
{
    public static class DependencyRegister
    {
        ...
        public static void Register(UnityContainer container)
        {
            ...
            container.RegisterType<IServicoRepository, ServicoRepository>(new HierarchicalLifetimeManager());
            ...
            container.RegisterType<IServicoItemRepository, ServicoItemRepository>(new HierarchicalLifetimeManager());
            ...
            container.RegisterType<IServicoApplicationService, ServicoApplicationService>(new HierarchicalLifetimeManager());
            ...
            container.RegisterType<IServicoItemApplicationService, ServicoItemApplicationService>(new HierarchicalLifetimeManager());
