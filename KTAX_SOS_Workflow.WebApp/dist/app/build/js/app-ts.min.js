...
(function (Consermaq) {
    var OrdemServicoController = (function () {
        function OrdemServicoController($location, ordemServicoService, toastr, mdDialog, timeout, $q) {
            this.$location = $location;
            this.ordemServicoService = ordemServicoService;
            this.toastr = toastr;
            this.mdDialog = mdDialog;
        ...
        ;
        OrdemServicoController.prototype.CpfClienteFilterCallback = function (names) {
            var arr = this.ordemServicos.filter(function (item) {
                return item.cliente.cpf.toLowerCase().indexOf(names.toLowerCase()) !== -1;
            });
            return this.$q.resolve(arr);
        };
        OrdemServicoController.prototype.CpfClienteTransformer = function (ordemServico) {
        ...
        OrdemServicoController.$inject = ['$location', 'OrdemServicoService', 'toastr', '$mdDialog', '$timeout', '$q'];
...
(function (Consermaq) {
    var ModalServicoController = (function () {
        function ModalServicoController(ordemServicoService, usuarioService, produtoService, servicoService, toastr, mdDialog, timeout, $q, ordemServico) {
            this.ordemServicoService = ordemServicoService;
            ...
            this.servico = new Consermaq.Servico();
        ...
        ModalServicoController.prototype.save = function () {
            if (this.adicionarMaterial)
                this.saveWithMaterial();
            else
                this.saveWithOutMaterial();
        };
        ModalServicoController.prototype.saveWithMaterial = function () {
            if (this.selectedItem.id) {
                ...
                this.servicoService.save(this.servico)
                    ...
                    .catch(function (response) { console.log("Erro"); });
            }
        };
        ModalServicoController.prototype.saveWithOutMaterial = function () {
        };
